                ...
                <blockquote className="mt-8">
                  <div className="relative text-lg font-medium text-white md:flex-grow">
                    ...
                    <p className="relative">
                      Enviser LMS is the learning management software for
                      future. The vision and the future is amazing. "
                    </p>
                  </div>

                  <footer className="mt-4">
                    <p className="text-base font-semibold text-indigo-200">
                      Sarah Williams, CEO at Enviser LMS
                    </p>
                  </footer>
                </blockquote>
              </div>
          ...
          <div className="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div className="mt-6 text-gray-500 space-y-6">
              ...
              <p className="text-base leading-7">
                The Enviser LMS is a web application which helps the people to
                search for a perfect mentor and enroll coursed according to
                their specific needs
              </p>
              <p className="text-base leading-7">
                Learning with Enviser LMS is fun and addictive. Earn points for
